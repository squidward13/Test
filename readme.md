...
7. git pull - **скачать репозиторий с github**
8. git clone - **скачать репозиторий с github**
9. git push - **отправить репозиторий в github**
10. git remote - **связать репозиторий с github**
